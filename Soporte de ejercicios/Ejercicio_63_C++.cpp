...
int cl,c11,c2,c3=0,ca=0,cp=0,cn1=0,num;
float nu;
int main(){
	titulo(1,63);
	cout<<"\tIngrese Acontinuacion valores para saber si son positivos o negativos \n\n";
	cout<<"\tIngrese la cantidad de numeros que desea ver: ";
	cin>>nu;
	while(cl<nu){
	cl++;
	cout<<"\n\tIngrese el valor "<<cl<<": ";
